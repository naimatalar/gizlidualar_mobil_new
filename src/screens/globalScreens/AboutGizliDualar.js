...
export const AboutGizliDualar = (props) => {
  useEffect(() => {
    ...
    props.navigation.setOptions({ title: "Bilgil" })
  }, [])
  ...
  return (
    <View style={{ margin: 10, flex: 1 }}>
      ...
      <View style={{ marginTop: 30, flex: 1 }}>
        <Text style={{ fontWeight: "bold", color: "blue", fontSize: 20, marginBottom: 5 }}> Anahtarlar Ne İşe Yarıyor?</Text>
        <Text style={{ fontSize: 16 }}>      Anahtarlar duaların tümünü görmek için kullanılır.
          <Text>       Anahtarlara belirli ücret karşılığında sahip olunur. Her duanın kaynağının bulunması ve araştırılmasında sarf edilen emeğe göre belirlenen sayıda anahtar gerektirir </Text>
        </Text>
        <View>
          <Text style={{ padding: 3, color: "red", fontWeight: "bold", fontSize: 16 }}>      Anahtarların ücretli çünkü, ekibimizin uygulamadaki dua, vefk ve zikir gibi birçok içeriğin derlenmesi sırasında birçok kişiler ve mekanlar ziyaret edilmesine kaynak çıkarmak zarureti olamsıdır.</Text>
        </View>
      </View>
      <View style={{
