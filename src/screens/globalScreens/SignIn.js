        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => setIsLogin(false)} style={{ alignItems: "center", paddingTop: 10 }}>
                    <Text style={!isLogin && { color: 'green', fontWeight: 'bold', textDecorationLine: "underline" } || { fontWeight: 'bold' }}>Kayıt Ol</Text>
                ...
                <TouchableOpacity onPress={() => setIsLogin(true)} style={{ alignItems: "center", paddingTop: 10 }}>
                    <Text style={isLogin && { color: 'green', fontWeight: 'bold', textDecorationLine: "underline" } || { fontWeight: 'bold' }}>Giriş Yap</Text>
                    {isLogin && <MaterialCommunityIcons
                        name={"arrow-up"}
                        size={17}
                        color={"green"}
            ...
            {isLogin && <View style={{
                ...
                <TouchableOpacity onPress={() => { authCode() }} style={{
                    ...
                    <Text style={{ color: "#fe7013", fontWeight: "bold" }}>Devam Et</Text>
                </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            if (!createUser.phoneNumber) {
                                Alert.alert("Eksik Bilgi", "Telefon alanı boş bırakılamaz")
                                return false
                            }
