  ...
  return (
    <Background>
      ...
      <LinearGradient start={{ x: 0.2, y: .3 }} style={{ padding: 7, width: "100%" }} colors={['#4c669f', 'transparent']} >
        <Text style={{ fontWeight: "bold", fontSize: 22, color: "white" }}>Dua Kategorileri</Text>
      </LinearGradient>
      <View style={{width:"100%",backgroundColor:"orange",padding:5}}>
        <Text style={{ fontSize: 12, color: "black",fontWeight:"bold" }}>İhtiyaç duyduğunuz Dua'ya buradan ulaşabilirsiniz...</Text>
