...
const Steps = (props) => {
    ...
    props.navigation.setOptions({ title: "Dua Uygulanış" })
            ...
            <View style={{ flex: 1, paddingTop: 15 }}>
                ...
                {!hiddenPage && <View style={{ flex: 6 }}>
                    {stepLenght > 1 && <View style={{ paddingLeft: 15, marginTop: 10 }}>
                        <Text style={{ fontWeight: "bold", color: "#fe7013", fontSize: 25 }}>      {selectedStep.sira}. Adım</Text>
                    </View>}
                ...
                {hiddenPage && <View style={{ flex: 6, justifyContent: "center", alignItems: "center" }}>
                    <MaterialCommunityIcons
                        ...
                        color={"red"}
                    />
                    <Text style={{ color: "red", fontSize: 25 }}>Bu adım kilitli</Text>
                    <View style={{ backgroundColor: "red", width: 100, justifyContent: "center" }}>

                        <Text style={{ textAlign: "center" }}>
                            <Text style={{ color: "white", fontSize: 18, fontWeight: "bold" }}>{duaCoin} </Text>
                            <MaterialCommunityIcons
                                name={"key"}
                                size={24}
                                color={"white"}
                    ...
                    <TouchableOpacity onPress={DuaKilitAc} style={{ flexDirection: "row", padding: 10, marginTop: 20, backgroundColor: "#a8cea9", borderColor: "#4CAF50", borderWidth: 1, borderStyle: "solid" }}>
                        <MaterialCommunityIcons
                            name={"lock-open"}
                            size={20}
                            color={"green"}
                        /><Text style={{ fontSize: 18, color: "green" }}> Kilidi kaldırmak için dokunun</Text>
                    </TouchableOpacity>
                </View>}
                    ...
                    <TouchableOpacity onPress={() => stepChange(-1)} style={{ justifyContent: "center", flexDirection: "column", height: 60, borderTopRightRadius: 50, alignItems: "center", backgroundColor: "#fe7013", flex: 3 }} >
                        <Text>
                            <MaterialCommunityIcons
                                ...
                                color={"white"}
                            /> </Text>
                        <Text style={{ color: "white" }}>Sonraki Adım</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity onPress={() => stepChange(+1)} style={{ justifyContent: "center", height: 60, flexDirection: "column", borderTopLeftRadius: 50, alignItems: "center", backgroundColor: "#fe7013", flex: 3 }} >
                        <Text>
                            <MaterialCommunityIcons
                                ...
                                color={"white"}
                            /> </Text>
                        <Text style={{ color: "white" }}>Sonrak Adım</Text>
                    </TouchableOpacity>
                </View>}
                    ...
                    <Dialog.Content>
                        <View>
                            ...
                            <View style={{ flexDirection: "row", justifyContent: "space-evenly", marginTop: 30, paddingBottom: 5 }}>
                                ...
                                <TouchableOpacity onPress={() => setAlertDialog(false)} style={{ backgroundColor: "red", width: 100, justifyContent: "center" }}><Text style={{ textAlign: "center", color: "white", fontWeight: "bold", fontSize: 16, padding: 8 }}>Vazgeç</Text></TouchableOpacity>
                            </View>
                        </View>
