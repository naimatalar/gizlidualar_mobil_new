            ...
            <View style={{ flex: 1, width: "100%" }}>
                ...
                <View style={{
                    ...
                    <Text style={{ fontSize: 20, textAlign: "center" }}>
                        {LangApp("anahtarPaket")}
                    </Text>
                    <Text style={{ fontSize: 15, textAlign: "center" }}>
                        {LangApp("anahtarDikkatli")}
                    </Text>
                                ...
                                <View style={{
                                    ...
                                    <View style={{ alignItems: "center", flexDirection: "row", justifyContent: "center" }}>
                                        ...
                                        {item.identifier == 400 && <>
                                            ...
                                            <Text style={{ fontSize: 18, fontWeight: "bold", color: "#512DA8" }}> {LangApp("smallAnahtar")}</Text>
                                        </>
                                        }
                                        {item.identifier == 800 && <>
                                            <MaterialCommunityIcons
                                            ...
                                            <Text style={{ fontSize: 20, fontWeight: "bold", color: "#FF6D00" }}>{LangApp("mediumAnahtar")}</Text>
                                        </>
                                        }
                                        {item.identifier == 1000 && <>
                                            <MaterialCommunityIcons
                                            ...
                                            <Text style={{ fontSize: 20, fontWeight: "bold", color: "#D50000" }}>{LangApp("highAnahtar")}</Text>
                                        </>
                                        }                
                                        {item.identifier == 2000 && <>
                                            <MaterialCommunityIcons
                                            ...
                                            />
                                            <Text style={{ fontSize: 20, fontWeight: "bold", color: "#D50000" }}> {item.identifier} </Text>
                                            <Text style={{ fontSize: 20, fontWeight: "bold", color: "#D50000" }}>{LangApp("premiumAnahtar")}</Text>
                                        </>
                                        } 
                                    ...
                                    <View style={{ marginBottom: 10, marginTop: 10, alignItems: "center", flexDirection: "row", justifyContent: "center" }}>
                                        <TouchableOpacity onPress={() => setPurchasesPackage(item)} style={{ backgroundColor: "#660159", width: 200, padding: 5 }}>
                                            <Text style={{ textAlign: "center", fontWeight: "bold", color: "white", fontSize: 20 }}>{LangApp("hemenAl")}</Text>
                                        </TouchableOpacity>
