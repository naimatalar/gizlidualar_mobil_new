...
var ReactNativeZoomableView = /** @class */ (function (_super) {
    ...
    function ReactNativeZoomableView(props) {
        ...
        _this._getBoxDimensions = function (layoutEvent) {
            var _a = layoutEvent.nativeEvent.layout; _a.x; _a.y; var height = _a.height, width = _a.width;
            _this.setState({
                originalWidth: width,
        ...
        _this._handlePanResponderMove = function (e, gestureState) {
            ...
            if (gestureState.numberActiveTouches === 2) {
                ...
                if (_this.longPressTimeout && (Math.abs(gestureState.dx) > 5 || Math.abs(gestureState.dy) > 5)) {
                    clearTimeout(_this.longPressTimeout);
                    _this.longPressTimeout = null;
                }
                if (_this.gestureType !== 'pinch') {
        ...
        _this._handlePinching = function (e, gestureState) {
            ...
            var zoomLevel = (zoomChangeFromStartOfPinch * _this.state.lastZoomLevel + _this.state.lastZoomLevel * pinchToZoomSensitivity) /
        ...
        _this.gestureHandlers = reactNative.PanResponder.create({
            ...
            onPanResponderTerminationRequest: (_a = props.onPanResponderTerminationRequest) !== null && _a !== void 0 ? _a : (function (evt) { return false; }),
    ...
    ReactNativeZoomableView.prototype._zoomToLocation = function (x, y, newZoomLevel, bindToBorders, callbk) {
        ...
        this.setState(changeStateObj, function () {
            ...
            if (_this.props.onZoomAfter) {
                _this.props.onZoomAfter(null, null, _this._getZoomableViewEventObject());
            }
        });
    };
    /**
    ...
    ReactNativeZoomableView.prototype.zoomTo = function (newZoomLevel, bindToBorders) {
        ...
        return new Promise(function (resolve) {
            ...
            if (newZoomLevel >= _this.props.maxZoom || newZoomLevel <= _this.props.minZoom) {
                resolve(false);
                return;
            }
    ...
    ReactNativeZoomableView.prototype.render = function () {
        return (React__default["default"].createElement(reactNative.View, __assign({ style: styles.container }, this.gestureHandlers.panHandlers, { onLayout: this._getBoxDimensions }),
...
var ReactNativeZoomableViewWithGestures = /** @class */ (function (_super) {
    ...
    ReactNativeZoomableViewWithGestures.prototype.render = function () {
        return React__default["default"].createElement(ReactNativeZoomableView, __assign({}, this.props, { onShiftingEnd: this._onShiftingEnd }));
    };
    return ReactNativeZoomableViewWithGestures;
}(React__default["default"].Component));

exports.ReactNativeZoomableView = ReactNativeZoomableView;
exports.ReactNativeZoomableViewWithGestures = ReactNativeZoomableViewWithGestures;
