...
|         `labelStyles`         |                  TextStyle                   |                                                                                                                      undefined                                                                                                                      |                                                                        Set styles to the floating label component. For changing the text color of the label, use the **customLabelStyles** _colorFocused_ and _colorBlurred_.                                                                                |
